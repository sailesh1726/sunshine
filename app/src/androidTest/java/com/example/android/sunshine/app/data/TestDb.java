...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        TestUtilities.validateCurrentRecord("Error:Location Query Invalid",weatherCursor,weatherValues);

        assertFalse("Error: More than one record", weatherCursor.moveToNext());
    ...
    public long insertLocation() {
        ...
        assertTrue("Error: no records",cursor.moveToFirst());

        TestUtilities.validateCurrentRecord("Error:Location Query Invalid",cursor,testValues);
